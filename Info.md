# Appunti su Spring Boot

```Spring Boot = Spring Framework + Embedded HTTP servers – XML Configurations```

[Acronimi](Info/Acronym.md)  
[Maven](Info/Maven.md)  
[Java](Info/Java.md)  
[Lombok](Info/Lombok.md)  
[Spring Boot Project](Info/SpringBootProject.md)  
[Spring Boot Annotations](Info/SpringBootAnnotation.md)  
[Hibernate Architecture](Info/HibernateArchitecture.md)  
[Hibernate Annotations](Info/HibernateAnnotations.md)  
[Hibernate Practice](Info/HibernatePractice.md)  
[JUnit](Info/JUnit.md)  
[Eclipse](Info/Eclipse.md)  
...
- http://www.matteoavanzini.it/scrivere-web-app-con-spring/
